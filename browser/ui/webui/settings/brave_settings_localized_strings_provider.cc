...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Pin shortcut page
      ...
      {"adblockCustomScriptletMoveUpButton",
       IDS_BRAVE_ADBLOCK_CUSTOM_SCRIPTLET_MOVE_UP_BUTTON},
      {"adblockCustomScriptletMoveDownButton",
       IDS_BRAVE_ADBLOCK_CUSTOM_SCRIPTLET_MOVE_DOWN_BUTTON},
      ...
      {"adblockCustomScriptletDialogMimeLabel",
       IDS_BRAVE_ADBLOCK_CUSTOM_SCRIPTLET_DIALOG_MIME_LABEL},
